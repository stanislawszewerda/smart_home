...
import 'package:smart_home/app/home/iot_devices/cubit/iot_devices_cubit.dart';
      ...
      builder: (context, snapshot) {
        ...
        return ListView(
          children: [
            Container(
              decoration:
                  const BoxDecoration(color: Color.fromARGB(255, 152, 163, 0)),
              padding: const EdgeInsets.all(20.0),
              margin: const EdgeInsets.all(20.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            for (final document in documents) ...[
              Container(
                decoration:
                    const BoxDecoration(color: Color.fromARGB(61, 85, 255, 7)),
                padding: const EdgeInsets.all(20.0),
                margin: const EdgeInsets.all(20.20),
                child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
